...
IEEE Transactions on Image Processing (T-IP), 2024. (IF: 11.041, JCR Q1, CCF-A, Top journal in computer vision and artificial intelligence, 1 区)

SpFormer: Spatio-Temporal Modeling for Scanpaths with Transformer
Wenqi Zhong*, Linzhi Yu*, Chen Xia, Junwei Han, Dingwen Zhang. (*: 共同一作) 
